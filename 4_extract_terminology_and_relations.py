...
from hasextract.kext.evaluator import CompositeKnowledgeEvaluator, DescriptiveStatisticsEvaluator, OverlapEvaluator
...
setup_logging(console_log_output="stdout", console_log_level="debug", console_log_color=True,
              logfile_file="kext.log", logfile_log_level="debug", logfile_log_color=False,
...
if __name__ == "__main__":
    ...
    for input_file in tqdm(input_files, desc="Processing files"):
        ...
        for file in input_file:
            with open(file) as f:
                input_text += " " + f.read()
        logger.info("Running knowledge extraction pipeline...")
